...
"Lists are cute, but trees? Trees are where your code goes when it wants structure, hierarchy, and main-character energy."
...
Empty = your 'no tree here' placeholder.
...
## **3. Trees are recursive by nature**

You define them recursively → you process them recursively.
Simple clean symmetry.



## **18. RECURSION OVER TREES**

### **Hook**

"Working with trees is basically just:

* what to do with `Empty`
* what to do with `Node x left right`
  Repeat forever."

## **1. Example: size of tree**
...
Basically everything that has a hierarchy.



## **19. TYPE CLASS INSTANCE**

### **Hook**

"Type classes are like interfaces, but with Haskell drip. A type becomes an instance of a type class to gain abilities — equality, ordering, displaying, arithmetic, whatever."



## **1. Example: custom Show instance**

Say we have an expression type:
...
```haskell
print (Add (Num 3) (Mul (Num 4) (Num 2)))
```
...
## **2. Example: making Expr a Num instance**

This is low-key cursed but extremely convenient:
...
And Haskell builds an expression tree instead of doing the math.
It’s like operator overloading but legal.


## **3. General pattern**

To make a type live inside a type class:
...
You define the minimum required methods.

Examples:

* Eq → must define `(==)`
* Ord → must define `(<=)`
* Show → must define `show`
* Num → must define `+`, `-`, `*`, `fromInteger`

After that, your type gets extra powers for free.


## **4. Real-life analogy**

Type classes are like skillsets.
Your type learns a skill → it can be used in more places.

E.g.
If you become an instance of “Eq” → people can compare you.
If you become an instance of “Show” → people can print you.
If you become an instance of “Ord” → people can sort you.
